...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Annee</h1>
        </div>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                        <?php
                            ...
                            try{
                            $stmt = $conn->prepare("SELECT * FROM t_annee ORDER BY Annee DESC");
                            $stmt->execute();
                            foreach($stmt as $annee){
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <a href='#' class='btn btn-danger btn-sm btn-flat'><i class='fa fa-delete'></i> Delete</a>
                                    </td>
