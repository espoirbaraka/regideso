...
<div class="modal fade" id="addannee">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title" style="text-align: center;"><b>Ajouter une annee</b></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="operation/add_annee.php" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="col-sm-9">
                      <input type="number" id="annee" name="annee" class="form-control" placeholder="Annee">
                    </div>
                </div>
